...
from san.data.datasets.register_pcontext import PCONTEXT_SEM_SEG_CATEGORIES
    ...
    def predict(
        ...
        if isinstance(image_data_or_path, str):
            if image_data_or_path[-3:] == '.pt':
                ...
                image_data.save('input_image.png')
            else:
        ...
        if False:
            ...
            ori_vocabulary = PCONTEXT_SEM_SEG_CATEGORIES
            vocabulary = PCONTEXT_SEM_SEG_CATEGORIES
