...
class RecWithAttnbiasHead(nn.Module):
    ...
    def forward(self, features, attn_bias, normalize: bool = False):
        ...
        # print(attn_biases[0].shape, h, w) # 12, 1+100+H*W, 1+100+H*W
        ...
        if self.cross_attn:
            ...
            for i, resblock in enumerate(self.resblocks):
                ...
                intermediate_attn_weights.append(w)
        ...
        return sos_token, intermediate_features, intermediate_attn_weights
